...
const NavBar = () => {
  ...
  return (
    ...
    //   </ul>
    // </div>
    <nav className="md:bg-primary lg:h-16 md:h-20 md:flex md:items-center lg:items-center md:justify-center lg:justify-center bg-white">
      <div className="flex md:items-center lg:items-center md:justify-center lg:justify-center font-medium justify-around">
        <div className="z-50 p-5 md:w-auto w-full flex justify-between">
          <img
            src="/logo_.png"
            alt="logo"
            className="md:cursor-pointer h-16 pr-40"
          />
        ...
        <ul className="md:flex hidden items-center gap-8 md:w-auto lg:w-auto">
          <MenueItems />

          <li className="list-none border md:border-solid border-l-accent border-y-0 border-r-0 px-4">
            <Link
